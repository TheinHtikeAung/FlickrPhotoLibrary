...
#define kFlickrAPIKey @"9bddfc0dc4f7601ca7aeae2da1167165"
...
+ (NSString *)flickrSearchURLForSearchTerm:(NSString *) searchTerm
{
    ...
    return [NSString stringWithFormat:@"http://api.flickr.com/services/rest/?method=flickr.photos.search&api_key=%@&text=%@&per_page=200&format=json&nojsoncallback=1",kFlickrAPIKey,searchTerm];
}
